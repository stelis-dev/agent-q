...
struct ResponseWriter {
    ...
    void (*log_write_failure)(const char* response_type, const char* id) = nullptr;

    const char* method = nullptr;

    ResponseWriter() = default;

    constexpr ResponseWriter(
    ...
    ResponseWriter for_method(const char* next_method) const
    {
        ResponseWriter copy = *this;
