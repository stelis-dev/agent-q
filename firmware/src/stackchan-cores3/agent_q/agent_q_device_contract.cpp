...
constexpr AgentQDeviceMethodRow kDeviceMethods[] = {
    {"get_status", AgentQDeviceSessionRule::forbidden, AgentQDevicePayloadRule::forbidden, "no payload", "StatusResult", "status_material_consistency"},
    {"identify_device", AgentQDeviceSessionRule::forbidden, AgentQDevicePayloadRule::required, "IdentifyDevicePayload", "IdentifyDeviceResult", "identification_display"},
    {"connect", AgentQDeviceSessionRule::forbidden, AgentQDevicePayloadRule::required, "ConnectPayload", "ConnectResult", "provisioned_material_policy_auth_approval"},
    {"disconnect", AgentQDeviceSessionRule::required, AgentQDevicePayloadRule::forbidden, "no payload", "DisconnectResult", "active_session_cleanup"},
    {"get_capabilities", AgentQDeviceSessionRule::required, AgentQDevicePayloadRule::forbidden, "no payload", "CapabilitiesResult", "active_session_provisioned_material"},
    {"get_accounts", AgentQDeviceSessionRule::required, AgentQDevicePayloadRule::forbidden, "no payload", "AccountsResult", "active_session_account_material"},
    {"policy_get", AgentQDeviceSessionRule::required, AgentQDevicePayloadRule::forbidden, "no payload", "PolicyGetResult", "active_session_policy_store"},
...
const AgentQDeviceMethodRow* device_method_row(const char* method)
{
    ...
    for (const AgentQDeviceMethodRow& row : kDeviceMethods) {
...
const AgentQDeviceErrorRow* device_error_row(const char* code)
{
    ...
    for (const AgentQDeviceErrorRow& row : kDeviceErrors) {
...
{
    switch (rule) {
        case AgentQDeviceSessionRule::forbidden:
            return "forbidden";
        case AgentQDeviceSessionRule::required:
            return "required";
        case AgentQDeviceSessionRule::optional:
            return "optional";
    }
    return "";
}
...
{
    switch (rule) {
        case AgentQDevicePayloadRule::forbidden:
            return "forbidden";
        case AgentQDevicePayloadRule::required:
            return "required";
        case AgentQDevicePayloadRule::optional:
            return "optional";
    }
    return "";
}
