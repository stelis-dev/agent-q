...
constexpr const char* kTag = "AgentQDrawingSurface";

struct DrawingSurfaceState {
    lv_obj_t* panel = nullptr;
    AgentQUiPanelKind panel_kind = AgentQUiPanelKind::none;
    bool surface_ready = false;
    AgentQUiPanelDeletedCallback panel_deleted_callback = nullptr;
};
...
void on_panel_deleted(lv_event_t* event)
{
    ...
    const AgentQUiPanelKind deleted_kind = g_surface.panel_kind;
    ESP_LOGW(kTag, "Agent-Q panel was deleted by external UI state");
    g_surface.panel = nullptr;
    g_surface.panel_kind = AgentQUiPanelKind::none;
...
AgentQUiPanelKind drawing_surface_clear_panel_locked()
{
    ...
    const AgentQUiPanelKind panel_kind = g_surface.panel_kind;
    g_surface.panel = nullptr;
    g_surface.panel_kind = AgentQUiPanelKind::none;
    lv_obj_delete(panel);
    return panel_kind;
