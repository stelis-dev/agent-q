...
constexpr size_t kResponseStoreCapacity = 4;
...
constexpr size_t kResponseMaxSize = 4096;

enum class ResponseStoreOutcome {
    stored,     // newly stored
    ...
    too_large,  // serialized response exceeds kResponseMaxSize
...
enum class ResponseRetryLookup {
    not_found,
    match,
    conflict,
    invalid,
