...
int main()
{
    ...
    const char prologue[] =
        ...
        "aqlt:1?k=ble&svc=a6e31d1051a14f7a9b0a0a1c00000001&idfp=0102030405060708&non=1112131415161718&exp=600";
    ...
    uint8_t expected_message2[signing::kLocalTransportNoiseMessage2Bytes] = {
        ...
        0xed, 0xec, 0xef, 0xee, 0xe9, 0xe8, 0xeb, 0xea, 0x3f, 0x3a, 0x29, 0x57,
        0x97, 0xbb, 0xf3, 0x13, 0x09, 0x6b, 0xb7, 0x1c, 0xd3, 0xae, 0x5f, 0x28,
        0x81, 0x2c, 0x87, 0xe7, 0x59, 0x1b, 0x0b, 0xe3, 0xf3, 0x6b, 0x0d, 0x7c,
        0x23, 0x68, 0x2b, 0x90, 0x82, 0x13, 0x42, 0xae, 0x10, 0xe3, 0xae, 0x11,
        0x70, 0x53, 0xca, 0x35, 0x0c, 0x0f, 0xfc, 0xce, 0x11, 0x16, 0xf1, 0x36,
        0x9b, 0x76, 0x19, 0x13, 0x92, 0xb9, 0x22, 0x85, 0x38, 0xa7, 0x5a, 0x1f,
        0x6a, 0xc0, 0xf0, 0xd5, 0x56, 0x38, 0x08, 0x17,
    };
    ...
    uint8_t expected_message3[signing::kLocalTransportNoiseMessage3Bytes] = {
        0x96, 0x64, 0xe3, 0x6b, 0x79, 0xc0, 0xf7, 0x07, 0x58, 0x20, 0x7b, 0x79,
        0xc6, 0x7a, 0x0b, 0x8d, 0x54, 0xac, 0xfa, 0x32, 0xba, 0xb3, 0x42, 0x7a,
        0x0a, 0xb9, 0xb2, 0xd7, 0x17, 0x99, 0xf2, 0x26, 0xb7, 0x77, 0x41, 0x63,
        0x8b, 0x4c, 0x45, 0xa2, 0xed, 0x7d, 0x41, 0x72, 0xa1, 0x7b, 0x49, 0x76,
        0x8b, 0x2a, 0x39, 0x68, 0x3c, 0x7b, 0xdf, 0x2f, 0xf6, 0xfc, 0x67, 0x3e,
        0x1e, 0xf2, 0xd3, 0x29,
    };
    ...
    uint8_t expected_handshake_hash[signing::kLocalTransportNoiseHandshakeHashBytes] = {
        0x64, 0xf1, 0x7e, 0x7f, 0x38, 0xf3, 0x2c, 0x59, 0x1a, 0xfb, 0x1e, 0x7b,
        0x82, 0xa4, 0x28, 0x1d, 0x0a, 0x07, 0x6e, 0xd3, 0x32, 0x7f, 0xfe, 0x6d,
        0xde, 0x5b, 0xf6, 0x62, 0x10, 0x83, 0x76, 0x9d,
    };
