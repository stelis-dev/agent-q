...
SIGNING_PREFLIGHT_SOURCE="${REPO_ROOT}/firmware/src/common/signing/signing_preflight.cpp"
...
USER_SIGNING_SOURCE="${REPO_ROOT}/firmware/src/common/signing/user_signing_critical_section.cpp"
USER_SIGNING_CONFIRMATION_SOURCE="${REPO_ROOT}/firmware/src/stackchan-cores3/runtime/user_signing_confirmation.cpp"
USER_FLOW_HEADER="${REPO_ROOT}/firmware/src/common/signing/user_signing_flow.h"
USER_SIGNING_HEADER="${REPO_ROOT}/firmware/src/common/signing/user_signing_critical_section.h"
SIGN_TRANSACTION_INGRESS_SOURCE="${REPO_ROOT}/firmware/src/common/signing/sign_transaction_user_ingress.cpp"
SIGN_PERSONAL_MESSAGE_INGRESS_SOURCE="${REPO_ROOT}/firmware/src/common/signing/sign_personal_message_user_ingress.cpp"
